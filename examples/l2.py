...
result = compute_pair_metric("L2", data, ref, dims="hwc", compute_map=True)
...
ds = Dataset(file='out_l2/data.json', single_item=True, auto_write=True)
...
print()
print("To view run: \"iviz out_l2/data.json\"")
print()
